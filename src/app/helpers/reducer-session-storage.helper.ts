...
import { ISessionStorageReducerState } from '../models/reducer-session-storage.model';
import { WasRefresh } from '../helpers/was-refresh';
...
export function getSessionStorageReducerState(reducerName: string, onlyReturnOnRefresh = true): any {
    if (!onlyReturnOnRefresh || WasRefresh()) {
